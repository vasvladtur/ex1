...
15. Дополнительные реквизиты в сериях номенклатуры в 1С:ERP 2.5

15.1. Создаем новый ВидНоменклатуры  для серийного учета (_Продукция серийного учета)

15.1.1. Доп реквизит Создаем реквизит "Номер ярлыка" с типом значения число (10,0) (НомерЯрлыка_bca1b17d26e243e8ad04fd9038f569a6)

15.1.2. Доп реквизит Создаем реквизит  "Вес НЕТТО"  с типом значения число (15,3)


15.2. Допустим, работа с сериями готовой продукции осуществляется только из документа производство без заказа, 
...
15.3. В обработке "ПодборСерийВДокументы" добавляем реквизит "др_партия"
...
15.4. При создании новой серии в ТЧ, нам нужно будет заполнить наш реквизит др_МаксНомерКатушки.
